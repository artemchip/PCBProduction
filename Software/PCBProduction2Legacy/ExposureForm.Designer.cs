namespace PCBProduction2
{
    partial class ExposureForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnPrintFilm = new RedButton();
            lblRenderDpi = new Label();
            nudRenderDpi = new RedUpDown();
            gbControls = new RedGroupBox();
            btnExpose = new RedButton();
            btnSaveImg = new RedButton();
            lblWhiteCount = new Label();
            lblMatrix = new Label();
            btnBrowseMatrix = new RedButton();
            tbMatrixPath = new RedTextBox();
            cbCompensateCNCLoss = new RedCheckBox();
            ...
            cbPositiveExposure.Location = new Point(5, 542);
            ...
            // btnPrintFilm
            // 
            btnPrintFilm.BackColor = Color.Black;
            btnPrintFilm.FlatStyle = FlatStyle.Flat;
            btnPrintFilm.ForeColor = Color.Red;
            btnPrintFilm.Location = new Point(104, 568);
            btnPrintFilm.Name = "btnPrintFilm";
            btnPrintFilm.Size = new Size(56, 23);
            btnPrintFilm.TabIndex = 5;
            btnPrintFilm.Text = "Печать";
            btnPrintFilm.UseVisualStyleBackColor = true;
            btnPrintFilm.Click += btnPrintFilm_Click;
            // 
            // lblRenderDpi
            // 
            lblRenderDpi.AutoSize = true;
            lblRenderDpi.Location = new Point(5, 381);
            ...
            nudRenderDpi.Location = new Point(5, 399);
            ...
            gbControls.Controls.Add(btnSaveImg);
            gbControls.Controls.Add(lblWhiteCount);
            gbControls.Controls.Add(lblMatrix);
            gbControls.Controls.Add(btnBrowseMatrix);
            gbControls.Controls.Add(tbMatrixPath);
            gbControls.Controls.Add(cbCompensateCNCLoss);
            ...
            gbControls.Controls.Add(btnPrintFilm);
            ...
            btnExpose.Location = new Point(5, 568);
            btnExpose.Name = "btnExpose";
            btnExpose.Size = new Size(93, 23);
            ...
            // btnSaveImg
            // 
            btnSaveImg.BackColor = Color.Black;
            btnSaveImg.FlatStyle = FlatStyle.Flat;
            btnSaveImg.ForeColor = Color.Red;
            btnSaveImg.Location = new Point(170, 568);
            btnSaveImg.Name = "btnSaveImg";
            btnSaveImg.Size = new Size(92, 23);
            btnSaveImg.TabIndex = 20;
            btnSaveImg.Text = "Сохранить";
            btnSaveImg.UseVisualStyleBackColor = true;
            btnSaveImg.Click += btnSaveImg_Click;
            // 
            // lblWhiteCount
            // 
            lblWhiteCount.Location = new Point(5, 281);
            ...
            lblMatrix.Location = new Point(5, 337);
            lblMatrix.Name = "lblMatrix";
            lblMatrix.Size = new Size(92, 15);
            lblMatrix.TabIndex = 18;
            lblMatrix.Text = "Файл матрицы:";
            // 
            // btnBrowseMatrix
            // 
            btnBrowseMatrix.BackColor = Color.Black;
            btnBrowseMatrix.FlatStyle = FlatStyle.Flat;
            btnBrowseMatrix.ForeColor = Color.Red;
            btnBrowseMatrix.Location = new Point(186, 355);
            btnBrowseMatrix.Name = "btnBrowseMatrix";
            btnBrowseMatrix.Size = new Size(75, 23);
            btnBrowseMatrix.TabIndex = 17;
            btnBrowseMatrix.Text = "Обзор...";
            btnBrowseMatrix.UseVisualStyleBackColor = true;
            btnBrowseMatrix.Click += btnBrowseMatrix_Click;
            // 
            // tbMatrixPath
            // 
            tbMatrixPath.BackColor = Color.Black;
            tbMatrixPath.BorderStyle = BorderStyle.FixedSingle;
            tbMatrixPath.ForeColor = Color.Red;
            tbMatrixPath.Location = new Point(5, 355);
            tbMatrixPath.Name = "tbMatrixPath";
            tbMatrixPath.ReadOnly = true;
            tbMatrixPath.Size = new Size(175, 23);
            tbMatrixPath.TabIndex = 16;
            // 
            // cbCompensateCNCLoss
            // 
            cbCompensateCNCLoss.AutoSize = true;
            cbCompensateCNCLoss.BackColor = Color.Black;
            cbCompensateCNCLoss.FlatStyle = FlatStyle.Flat;
            cbCompensateCNCLoss.ForeColor = Color.Red;
            cbCompensateCNCLoss.Location = new Point(5, 312);
            cbCompensateCNCLoss.Name = "cbCompensateCNCLoss";
            cbCompensateCNCLoss.Size = new Size(235, 19);
            cbCompensateCNCLoss.TabIndex = 15;
            cbCompensateCNCLoss.Text = "Компенсация погрешности отверстий";
            cbCompensateCNCLoss.UseVisualStyleBackColor = true;
            cbCompensateCNCLoss.CheckedChanged += cbCompensateCNCLoss_CheckedChanged;
            // 
            // tbBottomText
            // 
            ...
            tbBottomText.Location = new Point(5, 513);
            ...
            lblBotText.Location = new Point(5, 495);
            ...
            lblTopText.Location = new Point(5, 439);
            ...
            tbTopText.Location = new Point(5, 457);
            ...
            clbLayers.Size = new Size(256, 252);
        ...
        private RedButton btnPrintFilm;
        ...
        private RedCheckBox cbCompensateCNCLoss;
        private RedTextBox tbMatrixPath;
        private RedButton btnBrowseMatrix;
