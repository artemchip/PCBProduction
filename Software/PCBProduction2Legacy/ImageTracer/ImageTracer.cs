...
namespace ImageTracerNet
{
    public static class ImageTracer
    {
        ...
        internal static readonly List<ColorReference> Palette = new Color[] { Color.Black, Color.White }.Select(c => new ColorReference(c.A, c.R, c.G, c.B)).ToList();
        ...
        public static TracedImage PaddedPaletteImageToTraceData(Bitmap image, Tracing tracing, SvgRendering rendering)
        {
